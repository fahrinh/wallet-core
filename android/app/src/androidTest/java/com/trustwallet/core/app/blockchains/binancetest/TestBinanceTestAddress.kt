...
class TestBinanceTestAddress {
    ...
    fun testAddress() {
        ...
        val address = AnyAddress(pubkey, CoinType.BINANCETEST)
        val expected = AnyAddress("__EXPECTED_RESULT_ADDRESS__", CoinType.BINANCETEST)
